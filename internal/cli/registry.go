...
var operationCommands = []command.Command{
...
var cliRegistry = command.Registry{
	...
	Commands: append([]command.Command{
		...
		{Name: "send", Summary: "Send a named OCPP operation", Subcommands: operationCommands},
	}, append(operationCommands,
		command.Command{Name: "completions", Summary: "Generate bash or zsh completion scripts"},
		command.Command{Name: "help", Summary: "Print help"},
		command.Command{Name: "version", Summary: "Print version information"},
	)...),
}
